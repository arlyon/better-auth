...
export type BetterAuthOptions = {
  ...
  advanced?: {
    ...
    generateId?:
      ...
      | false;
    /**
     * Allow re-linking a social account
     *
     * By default, linking the same account twice will reject, however there are cases where this is useful,
     * such as if the user requires additional scopes, or if a scope grant requires additional config, which
     * changes the permissions of the refresh token.
     *
     * @default false
     */
