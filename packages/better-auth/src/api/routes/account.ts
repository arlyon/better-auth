...
/**
 * The endpoint for the oauth callback
 *
 * @param allowRelinking Allow re-linking an account if it was already linked. This effectively updates the scopes and overwrites the refresh token.
 * @returns An endpoint
 */
 ...
 * @returns An endpoint
 */
export const linkSocialAccount = (allowRelinking?: boolean) =>
  createAuthEndpoint(
    "/link-social",
    {
      method: "POST",
    ...
    async (c) => {
      ...
      if (!allowRelinking && existingAccount) {
